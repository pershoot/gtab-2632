...
#define AX88772B_MAX_BULKIN_LEN		(1024 * 16)
//#define AX88772B_MAX_BULKIN_LEN		(1024 * 2)
...
#define AX_RX_HEADER_DEFAULT		(AX_RX_CTL_RH1M | AX_RX_CTL_RH2M | AX_RX_CTL_RH3M)
#else
...
struct ax8817x_data {
	...
	union {
		...
		struct ax88772_data *ax772_data;
	} priv;
